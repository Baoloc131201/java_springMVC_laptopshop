...
import com.example.CURD_java_project.service.UploadService;
...
public class IUploadService implements UploadService {
    ...
    public IUploadService(ServletContext servletContext) {
    ...
    public String handleSaveUploadFile(MultipartFile file, String nameFolder) {
        ...
        try {
            ...
            File dir = new File(rootPath + File.separator + nameFolder);
            if (!dir.exists())
                dir.mkdirs();
