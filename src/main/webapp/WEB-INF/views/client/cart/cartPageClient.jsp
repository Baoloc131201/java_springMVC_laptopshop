                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="cartDetail" items="${listCartDetail}" varStatus="status">
                                        ...
                                        <div class="bg-light rounded">
                                            <div class="p-4">
                                                ...
                                                <div class="d-flex justify-content-between mb-4">
                                                    <h5 class="mb-0 me-4">Temporarily calculated:</h5>
                                                    <p id="temporary-total-price" class="mb-0" data-cart-total-price="${totalPrice}">
                                            ...
                                            <div
                                                ...
                                                <p id="final-total-price" class="mb-0 pe-4" data-cart-total-price="${totalPrice}">
                                                    <fmt:formatNumber type="number" value="${totalPrice}" /> đ
                                                </p>
                                            </div>
                                            ...
                                            <form:form action="/confirm-checkout" method="post" modelAttribute="cart">
                                                ...
                                                <button
                                                    class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4">Payment Confirmation
                                                </button>
                                            </form:form>
                                        </div>
                                    </div>
